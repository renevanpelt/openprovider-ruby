...
# Unit tests for OpenProvider::ResellerReseller
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResellerReseller' do
  before do
    # run before each test
    @instance = OpenProvider::ResellerReseller.new
  end
  ...
  describe 'test an instance of ResellerReseller' do
    it 'should create an instance of ResellerReseller' do
      expect(@instance).to be_instance_of(OpenProvider::ResellerReseller)
    end
  end
  ...
  describe 'test attribute "reserved_balance"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "vatperc"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
