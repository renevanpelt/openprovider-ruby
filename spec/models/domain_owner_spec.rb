...
# Unit tests for OpenProvider::DomainOwner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DomainOwner' do
  before do
    # run before each test
    @instance = OpenProvider::DomainOwner.new
  end
  ...
  describe 'test an instance of DomainOwner' do
    it 'should create an instance of DomainOwner' do
      expect(@instance).to be_instance_of(OpenProvider::DomainOwner)
    end
  end
