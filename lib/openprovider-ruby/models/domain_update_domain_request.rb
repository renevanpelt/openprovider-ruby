...
module OpenProvider
  class DomainUpdateDomainRequest
    attr_accessor :accept_update_fee
    ...
    attr_accessor :force_registry_update
    ...
    attr_accessor :remove_nses

    attr_accessor :reseller_handle

    attr_accessor :reset_auth_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenProvider::DomainUpdateDomainRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenProvider::DomainUpdateDomainRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'accept_update_fee')
        self.accept_update_fee = attributes[:'accept_update_fee']
      end
      ...
      if attributes.key?(:'force_registry_update')
        self.force_registry_update = attributes[:'force_registry_update']
      end
      ...
      if attributes.key?(:'remove_nses')
        self.remove_nses = attributes[:'remove_nses']
      end
      ...
      if attributes.key?(:'reset_auth_code')
        self.reset_auth_code = attributes[:'reset_auth_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accept_update_fee == o.accept_update_fee &&
          ...
          domain == o.domain &&
          force_registry_update == o.force_registry_update &&
          id == o.id &&
          ...
          remove_nses == o.remove_nses &&
          reseller_handle == o.reseller_handle &&
          reset_auth_code == o.reset_auth_code &&
    ...
    def hash
      [accept_update_fee, additional_data, admin_handle, auth_code, autorenew, billing_handle, comments, dnssec_keys, domain, force_registry_update, id, is_dnssec_enabled, is_locked, is_private_whois_enabled, is_sectigo_dns_enabled, is_spamexperts_enabled, name_servers, ns_group, ns_template_id, ns_template_name, owner_handle, remove_nses, reseller_handle, reset_auth_code, scheduled_at, tech_handle, use_domicile].hash
    end
