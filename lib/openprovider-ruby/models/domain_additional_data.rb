...
module OpenProvider
  class DomainAdditionalData
    ...
    attr_accessor :ae_acceptance

    attr_accessor :allocation_token

    attr_accessor :auth_code

    attr_accessor :bank_acceptance

    attr_accessor :company_registration_number

    attr_accessor :coop_acceptance
    ...
    attr_accessor :eligibility_type_relationship
    ...
    attr_accessor :insurance_acceptance
    ...
    attr_accessor :rurf_blocked_domains

    attr_accessor :self_service

    attr_accessor :trademark

    attr_accessor :trademark_id

    attr_accessor :travel_acceptance

    attr_accessor :vat

    attr_accessor :verification_code

    attr_accessor :vote_acceptance

    attr_accessor :voto_acceptance
    ...
    def self.openapi_types
      {
        ...
        :'ae_acceptance' => :'Object',
        :'allocation_token' => :'Object',
        :'auth_code' => :'Object',
        :'bank_acceptance' => :'Object',
        :'company_registration_number' => :'Object',
        :'coop_acceptance' => :'Object',
        :'customer_uin' => :'Object',
        :'customer_uin_doc_type' => :'Object',
        :'domain_name_variants' => :'Object',
        :'eligibility_type' => :'Object',
        :'eligibility_type_relationship' => :'Object',
        :'ftld_token' => :'Object',
        ...
        :'rurf_blocked_domains' => :'Object',
        :'self_service' => :'Object',
        :'trademark' => :'Object',
        :'trademark_id' => :'Object',
        :'travel_acceptance' => :'Object',
        :'vat' => :'Object',
        :'verification_code' => :'Object',
        :'vote_acceptance' => :'Object',
        :'voto_acceptance' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenProvider::DomainAdditionalData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenProvider::DomainAdditionalData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ae_acceptance')
        self.ae_acceptance = attributes[:'ae_acceptance']
      end

      if attributes.key?(:'allocation_token')
        self.allocation_token = attributes[:'allocation_token']
      end
      ...
      if attributes.key?(:'bank_acceptance')
        self.bank_acceptance = attributes[:'bank_acceptance']
      end
      ...
      if attributes.key?(:'coop_acceptance')
        self.coop_acceptance = attributes[:'coop_acceptance']
      end
      ...
      if attributes.key?(:'eligibility_type')
        self.eligibility_type = attributes[:'eligibility_type']
      end

      if attributes.key?(:'eligibility_type_relationship')
        self.eligibility_type_relationship = attributes[:'eligibility_type_relationship']
      end
      ...
      if attributes.key?(:'insurance_acceptance')
        self.insurance_acceptance = attributes[:'insurance_acceptance']
      end
      ...
      if attributes.key?(:'rurf_blocked_domains')
        self.rurf_blocked_domains = attributes[:'rurf_blocked_domains']
      end
      ...
      if attributes.key?(:'trademark_id')
        self.trademark_id = attributes[:'trademark_id']
      end

      if attributes.key?(:'travel_acceptance')
        self.travel_acceptance = attributes[:'travel_acceptance']
      end
      ...
      if attributes.key?(:'vote_acceptance')
        self.vote_acceptance = attributes[:'vote_acceptance']
      end

      if attributes.key?(:'voto_acceptance')
        self.voto_acceptance = attributes[:'voto_acceptance']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ae_acceptance == o.ae_acceptance &&
          allocation_token == o.allocation_token &&
          auth_code == o.auth_code &&
          bank_acceptance == o.bank_acceptance &&
          company_registration_number == o.company_registration_number &&
          coop_acceptance == o.coop_acceptance &&
          ...
          eligibility_type_relationship == o.eligibility_type_relationship &&
          ...
          insurance_acceptance == o.insurance_acceptance &&
          ...
          rurf_blocked_domains == o.rurf_blocked_domains &&
          self_service == o.self_service &&
          trademark == o.trademark &&
          trademark_id == o.trademark_id &&
          travel_acceptance == o.travel_acceptance &&
          vat == o.vat &&
          verification_code == o.verification_code &&
          vote_acceptance == o.vote_acceptance &&
          voto_acceptance == o.voto_acceptance
    end
    ...
    def hash
      [abogado_acceptance, admin_sing_pass_id, ae_acceptance, allocation_token, auth_code, bank_acceptance, company_registration_number, coop_acceptance, customer_uin, customer_uin_doc_type, domain_name_variants, eligibility_type, eligibility_type_relationship, ftld_token, gay_donation_acceptance, gay_rights_protection_acceptance, id_number, id_type, idn_script, insurance_acceptance, intended_use, law_acceptance, legal_type, maintainer, membership_id, mobile_phone_number_verification, ngo_ong_eligibility_acceptance, ngo_ong_policy_acceptance, passport_number, rurf_blocked_domains, self_service, trademark, trademark_id, travel_acceptance, vat, verification_code, vote_acceptance, voto_acceptance].hash
    end
