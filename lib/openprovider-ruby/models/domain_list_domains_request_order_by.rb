...
module OpenProvider
  class DomainListDomainsRequestOrderBy
    ...
    attr_accessor :domain_extension
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenProvider::DomainListDomainsRequestOrderBy` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenProvider::DomainListDomainsRequestOrderBy`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'domain_extension')
        self.domain_extension = attributes[:'domain_extension']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          domain_extension == o.domain_extension &&
    ...
    def hash
      [active_date, domain_extension, domain_name, expiration_date, id, order_date, renewal_date, status, transfer_date].hash
    end
