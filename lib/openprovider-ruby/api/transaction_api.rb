...
module OpenProvider
  class TransactionApi
    ...
    # @option opts [String] :end_creation_date The end creation date.
    # @option opts [String] :filter_for_subject The filter for subject.
    # @return [Array<(TransactionListTransactionsResponse, Integer, Hash)>] TransactionListTransactionsResponse data, response status code and response headers
    def list_transactions_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = '/v1beta/transactions'
      ...
      query_params[:'filter_for_subject'] = opts[:'filter_for_subject'] if !opts[:'filter_for_subject'].nil?
      ...
      return_type = opts[:return_type] || 'TransactionListTransactionsResponse' 
